                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-6 mb-6 text-white" >
                    ...
                    <div class="panel bg-gradient-to-r from-cyan-500 to-fuchsia-400" >
                        <div class="flex justify-between">
                            <div class="ltr:mr-1 rtl:ml-1 text-md font-semibold">My Tickets</div>
                        ...
                        <div class="flex items-center mt-5">
                            <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ $data['School Admin Tickets'] }}</div>
        ...
        <div x-data="finance">
            ...
            <div class="pt-5">
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-6 text-white" >
                    ...
                    <div class="panel bg-gradient-to-r from-cyan-500 to-fuchsia-400" >
                        <div class="flex justify-between">
                            <div class="ltr:mr-1 rtl:ml-1 text-md font-semibold">Total Visitor Currently IN</div>
                            <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                <a href="javascript:;" @click="toggle">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 hover:opacity-80 opacity-70">
                    ...
                    <div class="panel bg-gradient-to-r from-blue-500 to-fuchsia-400" >
                        <div class="flex justify-between">
                            <div class="ltr:mr-1 rtl:ml-1 text-md font-semibold">Total Security Counter</div>
                            <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                <a href="javascript:;" @click="toggle">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 hover:opacity-80 opacity-70">
                        ...
                        <div class="flex items-center mt-5">
                            <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{$totalsecurityCounter}}</div>
                            {{-- <div class="badge bg-white/30">- 0.35% </div> --}}
                        </div>
                        <div class="flex items-center font-semibold mt-5">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
