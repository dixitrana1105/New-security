                ...
                <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        ...
                        <form class="space-y-5 dark:text-white" method="POST" action="{{ route('super-admin.login') }}">
                            ...
                            {{-- <a href="/building_admin"  <button type="submit" class="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]"> Building </button></a>

                            <a href="/school_admin"  <button type="submit" class="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]"> School </button></a> --}}
                        </form>



                        {{-- <form class="space-y-5 dark:text-white" @submit.prevent="window.location='/dashboard'">
                            <div>
                                <label for="Email">User Name</label>
                                <div class="relative text-white-dark">
                            ...
                            <div>
                                <label for="SecretKey">Secret Key</label>
                                <div class="relative text-white-dark">
                                    <input id="SecretKey" type="password" placeholder="Enter Secret Key" class="form-input ps-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path opacity="0.5"
                                                d="M1.5 12C1.5 9.87868 1.5 8.81802 2.15901 8.15901C2.81802 7.5 3.87868 7.5 6 7.5H12C14.1213 7.5 15.182 7.5 15.841 8.15901C16.5 8.81802 16.5 9.87868 16.5 12C16.5 14.1213 16.5 15.182 15.841 15.841C15.182 16.5 14.1213 16.5 12 16.5H6C3.87868 16.5 2.81802 16.5 2.15901 15.841C1.5 15.182 1.5 14.1213 1.5 12Z"
